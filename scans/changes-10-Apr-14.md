...
| 183.com.cn           | not vulnerable.      |  no SSL.              | 
...
| babebuns.com         | not vulnerable.      |  no SSL.              | 
...
| indeed.com.br        | not vulnerable.      |  no SSL.              | 
...
| interpark.com        | not vulnerable.      |  no SSL.              | 
...
| jobomas.com          | not vulnerable.      |  no SSL.              | 
...
| komikid.com          | no SSL.              |  not vulnerable.      | 
...
| moviepilot.com       | no SSL.              |  not vulnerable.      | 
...
| phpclasses.org       | not vulnerable.      |  no SSL.              | 
...
| pricedealsindia.com  | not vulnerable.      |  no SSL.              | 
...
| propertyguru.com.sg  | no SSL.              |  not vulnerable.      | 
...
| rj.gov.br            | not vulnerable.      |  no SSL.              | 
...
| sexlunch.com         | no SSL.              |  vulnerable.          | 
...
| voegol.com.br        | not vulnerable.      |  no SSL.              | 
...
| washington.edu       | not vulnerable.      |  no SSL.              | 
...
| ziddu.com            | no SSL.              |  not vulnerable.      | 
